...
using Bonsai.Sound;
using Bonsai.Input;
using RcDeskPilot.AircraftEditor;
using System.Drawing;
//using System.Windows.Forms;
using RcDeskPilot.AircraftEditor.Dialogs;
using System.Windows.Forms;
using System.IO;
...
namespace RcDeskPilot
{
    internal class Program : IFrameworkCallback, IDeviceCreation
    {
        ...
        {
            RcDeskPilot.AircraftEditor.Dialogs.LicenseBox license = new LicenseBox();
            license.ShowDialog();
        }

        private void OnHelpAboutClicked(object sender, EventArgs e)
        {
            RcDeskPilot.AircraftEditor.Dialogs.AboutBox about = new AboutBox();
            about.ShowDialog();
        }
        #endregion
