...
namespace RcDeskPilot.AircraftEditor.Dialogs
{
    internal partial class SurfacePropertiesControl : UserControl
    {
        ...
        private void comboBoxChannel_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (surface != null)
            {
                surface.Channel = (RcDeskPilot.DataClasses.AircraftParameters.ChannelEnum)comboBoxChannel.SelectedIndex;
        ...
        private void comboBoxType_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (surface != null)
            {
                surface.ControlSurfaceType = (RcDeskPilot.DataClasses.AircraftParameters.ControlSurfaceTypeEnum)comboBoxType.SelectedIndex;
