namespace RcDeskPilot.AircraftEditor.Dialogs
{
    partial class ToolboxForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.surfacePropertiesControl = new RcDeskPilot.AircraftEditor.Dialogs.SurfacePropertiesControl();
            this.aircraftPanelControl = new RcDeskPilot.AircraftEditor.Dialogs.AircraftPanelControl();
            this.soundControl = new RcDeskPilot.AircraftEditor.Dialogs.SoundControl();
            this.collisionControl = new RcDeskPilot.AircraftEditor.Dialogs.CollisionControl();
            this.miscellaneousPanelControl = new RcDeskPilot.AircraftEditor.Dialogs.MiscellaneousPanelControl();
