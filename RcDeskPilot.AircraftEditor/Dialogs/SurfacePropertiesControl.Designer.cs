namespace RcDeskPilot.AircraftEditor.Dialogs
{
    partial class SurfacePropertiesControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.vectorControlRotationAxis = new RcDeskPilot.AircraftEditor.Dialogs.VectorControl();
            this.vectorControlPosition = new RcDeskPilot.AircraftEditor.Dialogs.VectorControl();
