namespace RcDeskPilot.AircraftEditor.Dialogs
{
    partial class AircraftParametersForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.sliderControlYawStability = new RcDeskPilot.AircraftEditor.Dialogs.SliderControl();
            this.sliderControlYawDamping = new RcDeskPilot.AircraftEditor.Dialogs.SliderControl();
            this.sliderControlRudderEfficiency = new RcDeskPilot.AircraftEditor.Dialogs.SliderControl();
            this.groupBoxPitch = new System.Windows.Forms.GroupBox();
            this.sliderControlPitchStability = new RcDeskPilot.AircraftEditor.Dialogs.SliderControl();
            this.sliderControlCoG = new RcDeskPilot.AircraftEditor.Dialogs.SliderControl();
            this.sliderControlTrim = new RcDeskPilot.AircraftEditor.Dialogs.SliderControl();
            this.sliderControlPitchDamping = new RcDeskPilot.AircraftEditor.Dialogs.SliderControl();
            this.sliderControlElevatorEfficiency = new RcDeskPilot.AircraftEditor.Dialogs.SliderControl();
            this.groupBoxRoll = new System.Windows.Forms.GroupBox();
            this.sliderControlSpinFactor = new RcDeskPilot.AircraftEditor.Dialogs.SliderControl();
            this.sliderControlDihedralEfficiency = new RcDeskPilot.AircraftEditor.Dialogs.SliderControl();
            this.sliderControlDihedralAngle = new RcDeskPilot.AircraftEditor.Dialogs.SliderControl();
            this.sliderControlAileronEfficiency = new RcDeskPilot.AircraftEditor.Dialogs.SliderControl();
            this.sliderControlRollDamping = new RcDeskPilot.AircraftEditor.Dialogs.SliderControl();
            this.groupBoxPropWash = new System.Windows.Forms.GroupBox();
            this.sliderControlPropWashAilerons = new RcDeskPilot.AircraftEditor.Dialogs.SliderControl();
            this.sliderControlPropWashElevator = new RcDeskPilot.AircraftEditor.Dialogs.SliderControl();
            this.sliderControlPropWashRudder = new RcDeskPilot.AircraftEditor.Dialogs.SliderControl();
