namespace RcDeskPilot
{
    ...
    internal class FlightModelApi : IAirplaneControl, IDisposable, IFlightModel
    {
        ...
        /// </summary>
        public RcDeskPilot.DataClasses.AircraftParameters AircraftParameters { get; set; }
        ...
        public void MoveScene(float elapsedTime)
        {
            lock (this)
            {
                ...
                // Calculate all forces on the airframe.
                if (AircraftParameters.FlightModelType == RcDeskPilot.DataClasses.AircraftParameters.FlightModelTypeEnum.Helicopter)
        ...
        RcDeskPilot.DataClasses.AircraftParameters IAirplaneControl.AircraftParameters
        {
            get
            {
