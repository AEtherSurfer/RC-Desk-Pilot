namespace RcDeskPilot
{
    ...
    using RcDeskPilot.Cameras;
    using RcDeskPilot.DataClasses;
    using RcDeskPilot.Dialogs;
    using System;
    ...
    internal class Program : IFrameworkCallback, IDeviceCreation
    {
        ...
        static int Main()
        {
            ...
            using (Framework framework = new Framework())
            {
                ...
                framework.Disposing += new EventHandler(RcDeskPilot.OnDestroyDevice);
                framework.DeviceLost += new EventHandler(RcDeskPilot.OnLostDevice);
                framework.DeviceCreated += new DeviceEventHandler(RcDeskPilot.OnCreateDevice);
                framework.DeviceReset += new DeviceEventHandler(RcDeskPilot.OnResetDevice);

                framework.SetWndProcCallback(new WndProcCallback(RcDeskPilot.OnMsgProc));

                framework.SetCallbackInterface(RcDeskPilot);
                try
                {
                    ...
                    // Initialize
                    RcDeskPilot.InitializeApplication();
                    ...
                    framework.Window.KeyDown += new System.Windows.Forms.KeyEventHandler(RcDeskPilot.OnKeyEvent);
                    framework.CreateDevice(0, true, Framework.DefaultSizeWidth, Framework.DefaultSizeHeight, RcDeskPilot);
        ...
        private void OnCreateDevice(object sender, DeviceEventArgs e)
        {
            ...
            Image splashBg = new Bitmap(this.GetType().Assembly.GetManifestResourceStream("RcDeskPilot.Resources.splash.png"));
        ...
        public void OnFrameRender(Microsoft.DirectX.Direct3D.Device device, double totalTime, float elapsedTime)
        {
            ...
            if ((Player != null) && (Player.Reflection != null))
            {
                ...
                else if (Effects.Reflection.ReflectionDetail == RcDeskPilot.Effects.Reflection.ReflectionDetailEnum.High)
