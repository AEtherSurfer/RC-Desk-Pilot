        ...
        internal class Bird : GameObject
        {
            ...
            public void OnFrameMove(Device device, double totalTime, float elapsedTime, int targetBird)
            {
                ...
                if (this.Update)
                {
                    ...
                    if (RcDeskPilot.Birds.ScareCrow != null)
                    {
                        Vector3 vDistance = RcDeskPilot.Birds.ScareCrow.Position - this.Position;

                        if (vDistance.LengthSq() < 100f)
                        {
                            this.Acceleration = this.Position - RcDeskPilot.Birds.ScareCrow.Position;
